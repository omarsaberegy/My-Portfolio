...
namespace Web.Controllers
{
    ...
    {
        private readonly IUnitOfWork<PotfolioItem> _portfolio;
        private readonly IHostingEnvironment _hosting;

        public ItemsController(IUnitOfWork<PotfolioItem> portfolio, IHostingEnvironment hosting)
        {
        ...
        public async Task<IActionResult> Create(PortfolioViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                PotfolioItem portfolioItem = new PotfolioItem
                {
